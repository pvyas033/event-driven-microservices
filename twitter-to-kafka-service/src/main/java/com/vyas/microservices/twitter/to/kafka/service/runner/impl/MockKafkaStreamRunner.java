package com.vyas.microservices.twitter.to.kafka.service.runner.impl;

import com.vyas.microservices.config.TwitterToKafkaServiceConfigData;
import com.vyas.microservices.twitter.to.kafka.service.exception.TwitterToKafkaServiceException;
import com.vyas.microservices.twitter.to.kafka.service.listener.TwitterKafkaStatusListener;
...
public class MockKafkaStreamRunner implements StreamRunner{
        ...
        Executors.newSingleThreadExecutor().submit(
                () -> {
                    try{
                        ...
                        LOG.error("Error creating twitter status !", t);
                    }
                }
        );
    }
    ...
    private void sleep(long sleepTimeMs){
        try{
            ...
            throw new TwitterToKafkaServiceException("Error while sleeping for waiting new status create!!");
        }
    }
